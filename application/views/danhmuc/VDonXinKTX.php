...
<head>
	...
	<page size="A4">
		...
		<br>
		<p class="paddingleft100">Tên tôi là: <b>{$sinhvien.hoten}</b> <span style="padding-left: 100px">(Nam/Nữ): <b>{$sinhvien.gioitinh}</b></span></p>
		<p class="paddingleft100">CMTND số: <b>{$sinhvien.CMND}</b> <span style="padding-left: 30px"> cấp ngày: <b>{$sinhvien.ngaycapcmnd}</b> </span> <span style="padding-left: 30px">nơi cấp: <b>{$sinhvien.noicapcmnd} </b></span></p>
		<p class="paddingleft100">Hộ khẩu thường trú: <b>{$sinhvien.hokhau}</b></p>
		<p class="paddingleft100">Sinh viên, học sinh năm thứ: nhất <span style="padding-left: 30px">lớp:......... </span><span style="padding-left: 30px"> khóa: <b>
		...
		<p class="paddingleft100">ngành (khoa): <b>{$sinhvien.sTen_Nganh}</b><span style="padding-left: 30px"> Trường: Đại học Mở Hà Nội </span> </p>
		<p class="paddingleft100">Số thẻ sinh viên, học sinh (nếu có): <b>{$sinhvien.masv}</b></p>
		<p class="paddingleft100">Đối tượng ưu tiên (nếu có) (2): <b>{$sinhvien.doituong}</b></p>
		<p class="paddingleft100">Tôi làm đơn này đề nghị: Ban QLVH Khu nhà ở xét duyệt cho tôi được thuê nhà ở </p>
		<p class="paddingleft100">tại Khu nhà ở sinh viên Pháp Vân - Tứ Hiệp.</p>
		<p class="paddingleft100">Tôi đã đọc Bản nội quy sử dụng nhà ở sinh viên và cam kết tuân thủ nội quy sử </p>
		<p class="paddingleft100">dụng nhà ở sinh viên; cam kết trả tiền thuê nhà đầy đủ, đúng thời hạn khi được thuê nhà ở.</p>
		<p class="paddingleft100">Tôi cam đoan những lời kê khai trong đơn là đúng sự thật, tôi xin chịu trách nhiệm </p>
		<p class="paddingleft100">trước pháp luật về các nội dung đã kê khai.</p>
