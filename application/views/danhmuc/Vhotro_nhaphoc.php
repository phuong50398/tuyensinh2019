                ...
                <form action="" method="post" enctype="multipart/form-data" autocomplete="off">
                    <div class="row ttsv">
                        ...
                        <div class="col-md-2">
                            ...
                            <span><input type="text" disabled name="tongdiem" class="form-control" value="{$data.tongdiem_xettuyen}"></span>
                        </div>
                    </div>
                    <div class="row ttsv">
                        {if !empty($data)}
                    ...
                    <div class="row ttsv">
                        ...
                        <div class="col-md-4">
                            ...
                            <span>
                               <input type="text" class="form-control " name="ngaysinh"  value="{if !empty($data)}{$data['ngaysinh']}{/if}" disabled>
                           </span>
                       </div>
                       <div>
                        <div class="main_anh">
