                    ...
                    <div class="row ttsv_tc-nh">
                        ...
                        <table class="table table-striped table-bordered"  id="{if !empty($timkiem) &&  $timkiem['hienthi'] != "all" && $timkiem['hienthi'] != "4"}table_id{/if}">
                            <thead>
                                ...
                                <th>{$val.mahp}</th>
                                {/foreach}
                                <th>Người lập hoá đơn gần nhất</th>
                            ...
                            <tbody> 
                                ...
                                <tr>
                                    <td class="text-center lg" ><b>{$val.stt}</b></td>
                                                                ...
                                                                <div class="input-many">
                                                                 ...
                                                                 <div class="input-many">
                                                                    ...
                                                                    <div class="col-md-9" style="padding: 0;">
                                                                        <input type="text" class="form-control tongtiendanop" placeholder="Tổng tiền" disabled="" value="{number_format($vct['tamthu_hp1'] + $vct['tamthu_hp2']+$vct['tamthu_sk']+$vct['tamthu_yt']+$vct['tamthu_tt1']+$vct['tamthu_tt2'])}">
                                                                    </div>
                                                                      <p>&nbsp;</p>
                                                                </div>
                                                                <div class="input-many">
                                                            ...
                                                            <div class="col-md-2">
                                                                ...
                                                                <div class="input-many">
                                                                 ...
                                                                 <div class="input-many">
                                                                    <label class="col-md-3 control-label" style="font-size: 12px;padding-left: 0;">Tổng</label>
                                                                    <div class="col-md-9" style="padding: 0;">
                                                                        <input type="text" class="form-control" placeholder="Tổng tiền" disabled="" value="{number_format($vct['tamthu_hp1']+$vct['tamthu_hp2']+$vct['tamthu_sk']+$vct['tamthu_yt']+$vct['tamthu_tt1']+$vct['tamthu_tt2'])}">
                                                                    </div>
                                                                      <p>&nbsp;</p>
                                                                </div>
                                                                 <div class="input-many">
