        ...
        <form method="post" onsubmit="return checkvalidate()">
         <div class="row ttsv">
            ...
            <div class="col-md-2">
                ...
                <span>
                    <input type="text" class="form-control" value="{$sinhvien.tongdiem_xettuyen}" disabled>
                </span>
            </div>
        </div>
        <div class="row ttsv">
...
<div class="row ttsv">
    ...
    <div class="col-md-4">
        ...
        <span><input type="text" name="data[nangkhieu1]" placeholder="Ca hát, nhảy, múa..." class="form-control" value="{$sinhvien['nangkhieu']}" ></span>
    </div>
</div>
<div class="row ttsv">
