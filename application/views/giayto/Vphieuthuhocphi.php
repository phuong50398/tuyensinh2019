                ...
                <div class="row"  style="min-height: 500px;">
                    ...
                    <div class="col-md-12">
                        <div class="col-md-6 title-left">
                            ...
                            <p class="title-left-1">Tel:(024)3869 1253-Fax:(024)3623 0393 </p>
                        </div>
                    ...
                    <div class="col-md-12 thongtin_sv">
                        ...
                        <div class="col-md-10">
                            <p><b>{$sinhvien_in.hoten} --({$sinhvien_in.masv})--({$sinhvien_in.ngaysinh})
                            {if $sinhvien_in.FK_sMaNganh == 15 || $sinhvien_in.FK_sMaNganh == 63 || $sinhvien_in.FK_sMaNganh == 62 || $sinhvien_in.FK_sMaNganh == 61}
                                {if $danhmuc['tong2khoan5nam'] != $tien2khoan['tamthu_hp2']+$tien2khoan['tamthu_sk']}
                                    --{$lanthu}
                                {/if}
                            {else}
                                {if $danhmuc['tong2khoan4nam'] != $tien2khoan['tamthu_hp1']+$tien2khoan['tamthu_sk']}
                                    --{$lanthu}
                                {/if}
                            {/if}
                            </b></p>
