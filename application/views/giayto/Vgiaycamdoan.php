    ...
    <page size="A4">
		...
		<div class="cachdong">
			<div style="width:120%; ">
				<div >
					<br>
				Họ và tên: <b>{$sinhvien_in.hoten}</b>
				</div>
				<div >
					<br>
				...
				<div >
					<br>
				Thí sinh Khoa (Ngành): <b>{$danhmuc['khoa'][$sinhvien_in.FK_sMaNganh]['tenkhoa']}</b>
				</div>
				<div >
					<br>
		...
		<div class="cachdong" style="line-height: 30px">
			Tôi xin cam đoan sẽ hoàn thành hồ sơ còn thiếu trước 17h00 ngày 10/09/2019. Quá thời hạn trên mà tôi không hoàn thành, Tôi xin hoàn toàn chịu trách nhiệm và chấp nhận bị xóa tên khỏi danh sách trúng tuyển.
