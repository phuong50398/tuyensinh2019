...
<body>
	...
	<page size="A4">
		...
		<div class="canphai">
			<p>Số hồ sơ: <b>{$sinhvien_in.sohs_nh}</b></p>
		</div>
		<div>
		...
		<div style="width: 85%; float: left;">
			...
			<div class="cachdong" style=" width: 100%;">
				...
				<div style="width: 33%; float: left;">Tôn giáo: {if !empty($sinhvien_in.FK_tongiao)}{$danhmuc['tongiao'][$sinhvien_in.FK_tongiao]}{/if}</div>
			</div>
			<div class="cachdong" style=" width: 100%;">
				<div style="width: 66%; float: left;">Ngày sinh: {$sinhvien_in.ngaysinh}</div>
		...
		<div style="width: 50%;float: left;margin-bottom: 10px;margin-top: 5px;">
			<div style="width: 90%;float: left; font-size: 14px;">{$key+1}. <b>{$dsten_hs[$val.mahs]}
			{if isset($hoso_dacheck[$val['mahs']])}
			<p class="tonhat">Người thu hồ sơ:{$hososv[0].nguoithu_hoso} - {date('d/m/Y H:i:s', strtotime({$hososv[0].thoigian_thuhs}))}</p>
			{/if}
			</b></div>
		...
		<div style=" width: 100%;clear: both;">
			<p><b><i>Số giấy tờ đã thu {count($hoso_dacheck)}/{count($danhmuc['hoso'])}</i></b></p>
			<hr>
		</div>
		...
		<div style="display: flex; width: 100%;">
			<div style="width: 50%;">
				<p class="cangiua"><b>{if !empty($sinhvien_in['nguoithuhs'])} {$danhmuc['canbo'][$sinhvien_in['nguoithuhs']]}{/if}</b></p>
				<small>Cán bộ nhận hồ sơ: {if !empty($sinhvien_in['nguoithuhs'])} {$danhmuc['canbo'][$hososv[0]['nguoithu_hoso']]}
				{/if} - {if !empty($sinhvien_in['thoigian_thuhs'])} {date('d/m/Y H:i:s', strtotime({$hososv[0]['thoigian_thuhs']}))}{/if} </small>
			</div>
			<div style="width: 50%;">
	...
	{/for}
	 <page size="A4">
            ...
            <div class="cachdongp2">
                <div style="width:50%;">
                    Ngày sinh <b>{date('m/d/Y', strtotime({$sinhvien_in.ngaysinh}))}</b>
                </div>
                <div style="width: 50%;">
        ...
        <page size="A4">
            ...
            <div class="cachdong">
                <div style="width:85%; ">
                    ...
                    <div>
                        <br> Ngày sinh: <b>{date('m/d/Y', strtotime({$sinhvien_in.ngaysinh}))} </b>
                    </div>
                    <div>
