<?php 
    ...
    class Cbaocaothongke extends CI_Controller
    {
        ...
        public function index(){
            ...
            if($session['maquyen']==1 || $session['maquyen']==3 || $session['maquyen'] == 12){
        ...
        public function thongkesv($nganh, $danhmuc, $session,$trangthai){
            ...
            ***********************************************************************/
            ...
            if($trangthai == "danhaphoc"){
                ...
                $array_content['BF8'] = 'BHYT';
                $array_content['BG8'] = 'BHTT1';
                $array_content['BH8'] = 'BHTT2';
                $array_content['BI8'] = 'Tổng';
                ...
                $objPHPExcel->getActiveSheet()->getStyle('A8:BI'.$dem)->applyFromArray($styleArray);
                unset($styleArray);
                $array_bold = array('A8:BI8');
                foreach($array_bold as $cell){
                    $objPHPExcel->getActiveSheet()->getStyle($cell)->getFont()->setBold(true);
                }
                 // Chỉnh cỡ font
            ...
            foreach ($sinhvien AS $k => $v)
            {
                ...
                if($trangthai == 'danhaphoc'){
                    ...
                    if($v['FK_sMaNganh'] == 15 || $v['FK_sMaNganh'] == 63 || $v['FK_sMaNganh'] == 62 || $v['FK_sMaNganh'] == 61)
                    {
                       ...
                       $array_content['BG'.$indexRow]   = 0;
                       $array_content['BH'.$indexRow]   = $ds[$v['masv']]['tt2'];
                    }else{
                        $array_content['BC'.$indexRow]  = $ds[$v['masv']]['hp1'];
                        $array_content['BD'.$indexRow]  = 0;
                        $array_content['BG'.$indexRow]  = $ds[$v['masv']]['tt1'];
                        $array_content['BH'.$indexRow]  = 0;
                    }
                    $array_content['BE'.$indexRow]  = $ds[$v['masv']]['sk'];
                    $array_content['BF'.$indexRow]  = $ds[$v['masv']]['yt'];
                    $array_content['BI'.$indexRow]  =  $v['tongtien_dathu'];
        ...
        public function excel(){
            ...
            $objPHPExcel->getActiveSheet()->getStyle('A8:BH'.$dem)->applyFromArray($styleArray);
            unset($styleArray);
            }
            else if($this->input->get('id')=="trungtuyen" || $this->input->get('id')=="datragiaybao" || $this->input->get('id')=="dathuhocphi"){
                $objPHPExcel->getActiveSheet()->getStyle('A8:AR'.$dem)->applyFromArray($styleArray);
            unset($styleArray);
            }
            else{
                $objPHPExcel->getActiveSheet()->getStyle('A8:BB'.$dem)->applyFromArray($styleArray);
            ...
            if($this->input->get('id')=="dathuruthoso"){
                ...
                $array_content['AV8'] = "Y tế đã trả";
                $array_content['AW8'] = "Thân thể loại 1 đã trả";
                $array_content['AX8'] = "Thân thể loại 2 đã trả";
                $array_content['AY8'] = "Tổng tiền đã trả";
                $array_content['AZ8'] = "Học phí loại 1 còn lại";
                $array_content['BA8'] = "Học phí loại 2 còn lại";
                $array_content['BB8'] = "Sức khỏe còn lại";
                $array_content['BC8'] = "Y tế còn lại";
                $array_content['BD8'] = "Thân thể loại 1 còn lại";
                $array_content['BE8'] = "Thân thể loại 2 còn lại";
                $array_content['BF8'] = "Tổng tiền còn lại";
                $array_content['BG8'] = "Cán bộ rút hồ sơ";
                $array_content['BH8'] = "Thời gian rút hồ sơ";
                // $array_content['BI8'] = "Thời gian rút hồ sơ";
            ...
            foreach ($data AS $k => $v)
            {
                ...
                if($this->input->get('id')=="dathuruthoso"){
                    ...
                    $array_content['AV'.$indexRow] = $ruths['yt_tra'];
                    $array_content['AW'.$indexRow] = $ruths['tt1_tra'];
                    $array_content['AX'.$indexRow] = $ruths['tt2_tra'];
                    $array_content['AY'.$indexRow] = $ruths['tongtra'];
                    $array_content['AZ'.$indexRow] = $ruths['hp1_con'];
                    $array_content['BA'.$indexRow] = $ruths['hp2_con'];
                    $array_content['BB'.$indexRow] = $ruths['sk_con'];
                    $array_content['BC'.$indexRow] = $ruths['yt_con'];
                    $array_content['BD'.$indexRow] = $ruths['tt1_con'];
                    $array_content['BE'.$indexRow] = $ruths['tt2_con'];
                    $array_content['BF'.$indexRow] = $ruths['tongcon'];
                    $array_content['BG'.$indexRow] = $ruths['nguoi_ruthoso'];
                    $array_content['BH'.$indexRow] = date('d/m/Y H:i:s', strtotime($ruths['thoigian_ruthoso']));
                    // $array_content['BI'.$indexRow] = date('d/m/Y H:i:s', strtotime($ruths['thoigian_ruthoso']));
        ...
        public function xuatbaocao_taichinh(){
            ...
            $array_content['BF8'] = $dshp['tt1'];
            $array_content['BG8'] = $dshp['tt2'];
            $array_content['BH8'] = $dshp['yt'];
            $array_content['BI8'] = "Số giao dịch";
            $array_content['BJ8'] = "Tổng tiền";
            ...
            foreach ($dssv_dot AS $k => $value){
                ...
                foreach ($sv_dot as $key => $v) {
                    ...
                    $tennganh = $this->Mbaocaothongke->get_where_select1('tbl_nganh','sTen_Nganh','iMa_nganh',$v['FK_sMaNganh']);
                                ...
                                $array_content['AG'.$indexRow]  = $v['nangkhieu'];
                                $array_content['AH'.$indexRow]  = $v['chucvu'];
                                $array_content['AI'.$indexRow]  = $danhmuc['canbo'][$v['ngthu']];
                                ...
                                $array_content['BF'.$indexRow]  = $v['tamthu_tt1'];
                                $array_content['BG'.$indexRow]  = $v['tamthu_tt2'];
                                // pr($v['tamthu_tt2']);
                                $array_content['BH'.$indexRow]  = $v['tamthu_yt'];
                                $array_content['BI'.$indexRow]  = $v['pos'];
                                $array_content['BJ'.$indexRow]  = $tongtien_sinhvien;
