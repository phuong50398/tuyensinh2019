<?php 
	...
	class Cruthoso extends MY_Controller
	{
	    ...
	    public function ruthoso(){
	    	...
	    	$sinhvien = $this->Mruthoso->get_where('tbl_sinhvien','soBD',$data['soBD']);
	    	$tien_sinhvien = (float)$sinhvien[0]['tongtien_dathu'] - (float)$data['tongtra'];
	    	$trangthai['trangthai'] 	     = 5;
	    	$trangthai['tongtien_dathu']	 = $tien_sinhvien;
